  ...
  if(root) {
    ...
    function addButtons()
    {
        ...
        if (window.location.href.indexOf("https://forum.hardware.fr/forum2.php") == -1
           && window.location.href.indexOf("https://forum.hardware.fr/hfr/") == -1) {
       ...
       if(postId > 0 && (catId > 0 || catId == "prive")){
           let pseudos = root.querySelectorAll("table.messagetable > tbody > tr > td.messCase2 > div.toolbar > div.left:first-of-type");
      ...
      function displayBookmarksManagement(event) {
          ...
          for(let item of LocalMPStorage.bookmarks.list)
          {
              ...
              tdAuteur.style.fontWeight = "bold";
              tdAuteur.style.fontSize = "10px";
